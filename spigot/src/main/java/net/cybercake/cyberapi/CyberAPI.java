...
public class CyberAPI extends JavaPlugin {
     ...
     * <br> <br>
     * In order to Start CyberAPI, you must provide a '{@link FinalizedSettings}' object. To get this,
     * you must do:
     * <br>
     * {@code startCyberAPI(new Settings().*include settings you want*.build());}
     * <br>
     * (this is here: {@link Settings#Settings()})
     * <br> <br>
     * This will get you your {@link FinalizedSettings} object that you can then input into CyberAPI
     * and will automatically be read by CyberAPI
     * <br>
     * {@link FinalizedSettings} can be null! That just means all the settings will be their defaults.
