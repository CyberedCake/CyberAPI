...
public abstract class Command implements CommandExecutor, TabCompleter {
    ...
    private Command() { this.information = List.of(newCommand("").build()); }
    ...
    public Command(CommandInformation... information) {
        if(information.length < 1) throw new IllegalArgumentException("There must be at least **one** " + information.getClass().getCanonicalName() + " provided for constructor in " + Command.class.getCanonicalName() + "!");
