...
public class ServerListPingEvent extends ServerEvent implements Cancellable {
    ...
    public ServerListPingEvent(String versionName, int protocolVersion, boolean playerListVisible, boolean versionNameAlwaysVisible, MOTD motd, int maxPlayers, int onlinePlayerCount, List<String> onlinePlayers) {
