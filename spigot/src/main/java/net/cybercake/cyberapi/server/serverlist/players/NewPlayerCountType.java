package net.cybercake.cyberapi.server.serverlist.players;

import javax.annotation.Nullable;

/**
 * The new player count type used in {@link net.cybercake.cyberapi.server.serverlist.managers.PlayerListManager}
 */
