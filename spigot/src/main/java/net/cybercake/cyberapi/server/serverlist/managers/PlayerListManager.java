package net.cybercake.cyberapi.server.serverlist.managers;
...
import net.cybercake.cyberapi.server.serverlist.players.NewPlayerCountType;
...
public class PlayerListManager {
    ...
    public void setOnlinePlayers(String... players) {
        clearOnlinePlayers();
        List.of(players).forEach(this::addPlayerOnline);
    }
     ...
     * @since 3.1.0
     */
    public void addPlayerOnline(String player) {
     ...
     * @param player the player to remove from the hover event, must be an exact match to a currently online player to remove (alternatively, you could use {@link PlayerListManager#removePlayerOnline(int)})
     * @since 3.1.0
     */
    public void removePlayerOnline(String player) {
     ...
     * @param index the index of the player to remove, 0 being the first item on the list (alternatively, you could use {@link PlayerListManager#removePlayerOnline(String)})
     * @since 3.1.0
     * @throws IndexOutOfBoundsException if the index is out of bounds ({@code index < 0 || index >= size()})
     */
    public void removePlayerOnline(int index) {
        this.players.remove(index);
    }

    /**
     * Get a list of the fake online players provided by the user in {@link PlayerListManager#addPlayerOnline(String)} or {@link PlayerListManager#setOnlinePlayers(String...)}.
