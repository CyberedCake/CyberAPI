package net.cybercake.cyberapi.chat.centered;
...
public class CenteredMessage {
    ...
    public void send(CyberPlayer cyberPlayer) {
        if(cyberPlayer.getOnlineActions() == null) throw new IllegalStateException("That Cyber Player (" + cyberPlayer.getUniqueID() + "), must be online to send them a " + this.getClass() + "!");
