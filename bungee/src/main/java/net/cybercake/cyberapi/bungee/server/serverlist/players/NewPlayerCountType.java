package net.cybercake.cyberapi.bungee.server.serverlist.players;

import javax.annotation.Nullable;

/**
 * The new player count type used in {@link net.cybercake.cyberapi.bungee.server.serverlist.managers.PlayerListManager PlayerListManager}
 */
